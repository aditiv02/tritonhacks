...
class GeminiChatbot:
    ...
    def __init__(self, root):
        ...
        # Modify Send button to match other buttons
        self.send_btn = tk.Button(self.frame, text="Send", font=("Segoe UI", 13), command=self.send_message, bg="#e6f0fa", fg="#004a99", activebackground="#a9cde9", activeforeground="#003366", relief="raised", bd=3, cursor="hand2")
    ...
    def get_bot_reply(self, user_msg):
        if self.user_messages >= 3:
            ...
            # Make the Send button disappear after conversation ends
    ...
    def add_end_buttons(self):
        ...
        new_convo_btn = tk.Button(self.frame, text="Start New Conversation", font=("Segoe UI", 13), command=self.new_conversation, bg="#e6f0fa", fg="#004a99", activebackground="#a9cde9", activeforeground="#003366", relief="raised", bd=3, cursor="hand2")
        new_convo_btn.pack(pady=(10, 20))

        back_btn = tk.Button(self.frame, text="Back to Main Menu", font=("Segoe UI", 13), command=self.back_to_main, bg="#e6f0fa", fg="#004a99", activebackground="#a9cde9", activeforeground="#003366", relief="raised", bd=3, cursor="hand2")
